import { Typography,Box,styled, TableBody,Table, TableCell, TableRow } from "@mui/material";
    ...
    return(
        <>
            <Typography>{product.title.longTitle}</Typography>
                        <Typography style={{marginTop:5,color:'#878787',fondtsize:14}}>
                            8 Ratings & 1 Reviews
                        ...
                        <SmallText>
                            ...
                            <Typography><StyledBadge/>Signup for flipkart pay Later and get Flipkart Gift Card worth ₹100* Know More </Typography>
                            <Typography><StyledBadge/>Buy 2 items save 5%; Buy 3 or more  save 10% T&C  </Typography>
                            <Typography><StyledBadge/>5% Cashback on Flipkart Axis Bank Credit Card  </Typography>
                        ...
                        <Table>
                            <TableBody>
                                ...
                                <ColumnText>
                                    ...
                                    <TableCell style={{width:770}}>{product.description}</TableCell>
                                </ColumnText>
                            </TableBody>
                        </Table>
